...
import { PAGE_IDS, ImageSlotSchema, type PageId, type ImageSlot } from "./site-contracts";
import { factVocabulary, lintTrustContexts, UNSUPPORTED_FACT_PATTERNS, TRUST_CONTEXT_PATTERN } from "./fact-lint";

// Transition re-exports: the legacy generator's own tests still bind these
// here; the canonical home is ./site-contracts (+ ./fact-lint for the lint).
export { PAGE_IDS } from "./site-contracts";
export type { PageId, ImageSlot } from "./site-contracts";
export { factVocabulary, lintTrustContexts, UNSUPPORTED_FACT_PATTERNS } from "./fact-lint";
