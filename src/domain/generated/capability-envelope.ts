...
export const CAPABILITY_ENVELOPE = {
  ...
  "reference": {
    ...
    "fresh_capture_coordinate_space": "PAGE_SPACE",
    "capture_scroll_y_role": "OBSERVATIONAL_PROVENANCE",
    "legacy_coordinate_inference_fail_closed": true
  },
  ...
  "automation": {
    ...
    "informed_realization_repair_rounds": 1,
    "realization_repair_full_page_regeneration_allowed": false,
    "realization_repair_content_mutation_allowed": false,
    "realization_repair_escalation_code": "REALIZATION_REPAIR_INSUFFICIENT",
    "repair_scope_violation_is_deterministic_review": true,
    "assembly_repair_content_freeze": true,
    "assembly_repair_adopt_only_if_clean": true,
    "transient_platform_error_terminal_build_mutation": false,
    "workflow_reconciliation_terminal_authority": true
  },
  "benchmark": {
    "fixed_site_count": 5,
