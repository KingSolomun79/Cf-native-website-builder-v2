...
|---|---|---|
| Design Blueprint Generator (multimodal — Reference screenshots attached) | `simple-design-blueprint/v4` | `simple/01-design-blueprint.md` |
| Website Builder — the ONE visual owner | `simple-website-builder/v2` | `simple/02-website-builder.md` |
